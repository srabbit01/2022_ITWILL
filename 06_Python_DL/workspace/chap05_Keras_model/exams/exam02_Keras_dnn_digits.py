...
Epoch 100/100
40/40 [==============================] - 0s 2ms/step
 - loss: 0.0088 - accuracy: 1.0000 - val_loss: 0.0893 - val_accuracy: 0.9796
'''
...
model.save(path+'/keras_model_digits.h5')

# 2) model load
my_model=load_model(path+'/keras_model_digits.h5')