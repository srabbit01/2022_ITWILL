...
print(ratings)  # critic(평가자), title(영화제목), rating(평점)
...
'''
reset_index(): 재 인덱스 적용 
- 숫자를 색인으로 재인덱스를 적용한다.
- 적용하지 않으면 title이 칼럼이 아닌 행의 이름으로 사용됨
'''
...
movie_ratings.corr()
'''
critic    Claudia      Gene      Jack      Lisa      Mick      Toby
critic                                                             
Claudia  1.000000  0.314970  0.028571  0.566947  0.566947  0.893405
Gene     0.314970  1.000000  0.963796  0.396059  0.411765  0.381246
Jack     0.028571  0.963796  1.000000  0.747018  0.211289  0.662849
Lisa     0.566947  0.396059  0.747018  1.000000  0.594089  0.991241
Mick     0.566947  0.411765  0.211289  0.594089  1.000000  0.924473
...
# 2) 영화제목별 rating, Toby유사도, 유사도평점의 합계
...
# 3) 영화제목별 합계  Toby 영화추천 예측 = 유사도평점합계 / Tody유사도합계
print('\n*** 영화 추천 결과 ***')
